...
public class UserServiceImpl implements UserService {
	...
	public boolean updateUser(String userId, UserUpdatePutReq userUpdateInfo) {
		...
		if(departmentRepositorySupport.findDepartmentById(userUpdateInfo.getDepartmentId()).isPresent()){
			department = departmentRepositorySupport.findDepartmentById(userUpdateInfo.getDepartmentId()).get();
		} else department = new Department("No");
